...
{
  public class SuryaVendorAuthenticator : IVendorAuthenticator<SuryaHomewareVendor>
  {
    public async Task<AuthenticationResult> LoginAsync()
    {
      ...
      values.Add("p$lt$ctl06$pageplaceholder$p$lt$ctl01$logonform$Login1$Password", "passwordhereK");
