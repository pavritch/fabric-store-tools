...
namespace ProductScanner.App.Controls
{
    ...
    public class Arc : Shape
    {
        ...
        {
            // { StartLineCap = PenCap, EndLineCap = PenCap }
            drawingContext.DrawGeometry(null, new Pen(Stroke, StrokeThickness) { StartLineCap = this.StrokeStartLineCap, EndLineCap = this.StrokeEndLineCap }, GetArcGeometry());
        }
