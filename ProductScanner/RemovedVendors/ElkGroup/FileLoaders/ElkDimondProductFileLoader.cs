...
{
    public class ElkDimondProductFileLoader
    {
        ...
        public ElkDimondProductFileLoader(IStorageProvider<ElkGroupVendor> storageProvider) { _storageProvider = storageProvider; }
        ...
        public List<ScanData> LoadInventoryData()
        {
            ...
            return fileLoader.Load(Path.Combine(staticFileFolder, "Dimond Product_Data.xlsx"), Properties, ScanField.ManufacturerPartNumber, 1, 2);
        }
    }
}