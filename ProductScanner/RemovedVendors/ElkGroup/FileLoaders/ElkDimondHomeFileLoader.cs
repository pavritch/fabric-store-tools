...
{
    public class ElkDimondHomeFileLoader
    {
        private static readonly List<FileProperty> Properties = new List<FileProperty>
        {
            ...
            new FileProperty("New", ScanField.Ignore),
            ...
            new FileProperty("Item 2 Height", ScanField.Ignore),
            new FileProperty("Item 2 Width", ScanField.Ignore),
            new FileProperty("Item 2 Length", ScanField.Ignore),
            new FileProperty("Item 3 Height", ScanField.Ignore),
            new FileProperty("Item 3 Width", ScanField.Ignore),
            new FileProperty("Item 3 Length", ScanField.Ignore),
        ...
        public ElkDimondHomeFileLoader(IStorageProvider<ElkGroupVendor> storageProvider) { _storageProvider = storageProvider; }
        ...
        public List<ScanData> LoadInventoryData()
        {
            ...
            return fileLoader.Load(Path.Combine(staticFileFolder, "Dimond Home_Data.xlsx"), Properties, ScanField.ManufacturerPartNumber, 1, 2);
        }
    }
}