...
{
    public class ElkProductFileLoader
    {
        ...
        public ElkProductFileLoader(IStorageProvider<ElkGroupVendor> storageProvider) { _storageProvider = storageProvider; }
        ...
        public List<ScanData> LoadInventoryData()
        {
            ...
            return fileLoader.Load(Path.Combine(staticFileFolder, "ELK_Data.xlsx"), Properties, ScanField.ManufacturerPartNumber, 1, 2);
        }
    }
}