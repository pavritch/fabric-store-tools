...
{
    public class ElkAlicoFileLoader
    {
        private static readonly List<FileProperty> Properties = new List<FileProperty>
        {
            ...
            new FileProperty("Room Setting", ScanField.Ignore),
        ...
        public ElkAlicoFileLoader(IStorageProvider<ElkGroupVendor> storageProvider) { _storageProvider = storageProvider; }
        ...
        public List<ScanData> LoadInventoryData()
        {
            ...
            return fileLoader.Load(Path.Combine(staticFileFolder, "Alico_Data.xlsx"), Properties, ScanField.ManufacturerPartNumber, 1, 2);
        }
    }
}