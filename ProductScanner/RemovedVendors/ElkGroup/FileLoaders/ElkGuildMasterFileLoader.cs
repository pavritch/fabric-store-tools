...
{
    public class ElkGuildMasterFileLoader
    {
        ...
        public ElkGuildMasterFileLoader(IStorageProvider<ElkGroupVendor> storageProvider) { _storageProvider = storageProvider; }
        ...
        public List<ScanData> LoadInventoryData()
        {
            ...
            return fileLoader.Load(Path.Combine(staticFileFolder, "Guild Master_Data.xlsx"), Properties, ScanField.ManufacturerPartNumber, 1, 2);
        }
    }
}