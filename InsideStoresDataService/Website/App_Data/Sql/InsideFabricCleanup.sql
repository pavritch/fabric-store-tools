...
-- ensure min qty is 2 for any fabric/trim under $100 price
update ProductVariant set MinimumQuantity=2 where Name='Yard' and ISNULL(MinimumQuantity, 1) = 1 and Price < 100.00 and ProductID in (select ProductID from Product where ProductGroup in ('Fabric', 'Trim'))
