...
namespace Website
{
    public class FroogleDescriptionMakerFabric : FabricDescriptionMakerBase
    {
        public FroogleDescriptionMakerFabric(InsideFabricProduct product)
            : base(product)
        {
            ...
            {
                case "Fabric":
                    list.Add(ContributeIntroFabric);
                    break;

                case "Trim":
                    list.Add(ContributeIntroTrim);
                    break;
        ...
        private void ContributeIntroFabric(PhraseManager mgr)
        {
        ...
        private void ContributeIntroTrim(PhraseManager mgr)
        {
            List<PhraseVariant> currentList = null;
