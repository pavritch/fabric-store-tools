...
namespace Website
{
    ...
    public class WallpaperDescriptionMakerBase
    {
        protected readonly InsideWallpaperProduct product;
        ...
        public WallpaperDescriptionMakerBase(InsideWallpaperProduct product)
        {
