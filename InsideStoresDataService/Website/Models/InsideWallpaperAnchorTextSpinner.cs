...
namespace Website
{
    public class InsideWallpaperAnchorTextSpinner
    {
        ...
        readonly InsideWallpaperProduct product;

        public InsideWallpaperAnchorTextSpinner(InsideWallpaperProduct product)
        {
