...
namespace Website
{
    ...
    /// </remarks>
    public class InsideWallpaperProduct : InsideStoresProductBase, IUpdatableProduct
    {
        ...
        {
            private InsideWallpaperProduct p;
            ...
            public ProductProperties(InsideWallpaperProduct p, Dictionary<string, string> originalProperties)
            {
                this.p = p;
                ...
                get
                {
                    ...
                    foreach (var key in originalProperties.Keys)
                    {
                        ...
                        else
                        {
                            ...
                            Debug.WriteLine(string.Format("Uknown property label: {0}", key));
                        }
                    }
        ...
        {
            new ProductKindCategoryAssoc(ProductKind.Wallcovering, new List<int> { 79, 147, 148, 149 }),
        ...
        public InsideWallpaperProduct()
        {
            IsValid = false;
        }

        public InsideWallpaperProduct(IWebStore store, Product p, List<ProductVariant> variants, Manufacturer m, List<Category> categories, AspStoreDataContext dc)
            : this()
        {
        ...
        public ProductKind KindOfProduct
        {
            get
            {
                ...
                switch (p.ProductGroup ?? string.Empty)
                {
                    ...
                    case "Wallcovering":
                        _productKind = ProductKind.Wallcovering;
                        break;
        ...
        public string Brand
        {
            get
            {
                return m.Name.Replace(" Fabrics", "").Replace(" Fabric", "").Replace(" Wallpapers", "").Replace(" Wallpaper", "").Replace(" Wallcoverings", "").Replace(" Wallcovering", "");
            }
        }
        ...
        protected override bool SpinSEDescription()
        {
            try
            {
                ...
                var maker = new SEDescriptionMakerWallpaper(this);
        ...
        protected override bool SpinFroogleDescription()
        {
            try
            {
                if (p.ProductGroup == null || p.ProductGroup != "Wallcovering")
                    return false;

                var maker = new FroogleDescriptionMakerWallpaper(this);
        ...
        public void CleanUpExtensionData4()
        {
            try
            {
                ...
                var oldKeys = new string[] {"OriginalSEDescription", "OriginalSEKeywords", "OriginalDescription", "IsSpunDescription", "IsSpunSEDescription", "IsSpunSEKeywords" };
