...
namespace Website
{
    public class InsideFabricShoppingFeedProduct : ShoppingFeedProduct
    {

        public InsideFabricShoppingFeedProduct(InsideFabricFeedProduct feedProduct) : base(feedProduct)
        {
            try
            {
