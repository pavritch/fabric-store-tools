...
namespace Website
{
    ...
    /// </remarks>
    public class InsideFabricFeedProduct : IStoreFeedProduct
    {
        ...
        public InsideFabricFeedProduct()
        {
            IsValid = false;
        }

        public InsideFabricFeedProduct(IWebStore store, Product p, ProductVariant pv, Manufacturer m, List<Category> categories, AspStoreDataContextReadOnly dc) : this()
        {
            this.Store = store;
            this.p = p;
            this.pv = pv;
