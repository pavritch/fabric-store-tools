...
namespace ControlPanel.ViewModels
{
    ...
    public class SalesSummaryPageViewModel : ValidatingViewModelBase, IViewModelPageNavigation
    {
        ...
        public SalesSummaryPageViewModel()
        {
        ...
        private void ExecuteExportOrdersCommand(object parameter)
        {
            ...
            ctx.ExportSalesOrders(StoreKey, startDate, endDate, (result) =>
            {
