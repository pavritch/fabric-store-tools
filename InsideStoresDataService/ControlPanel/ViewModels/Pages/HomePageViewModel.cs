...
namespace ControlPanel.ViewModels
{
    ...
    public class HomePageViewModel : ValidatingViewModelBase, IViewModelPageNavigation
    {
        public class BarChartDataPoint
        {
            ...
            public BarChartDataPoint(string category, int value1=0, int value2=0, int value3=0, int value4=0)
            {
        ...
        private void InitChartLegend()
        {
            ...
            {
                new ChartLegendItem("Inside Fabric", "#FF8EC441"),
                new ChartLegendItem("Inside Rugs", "#FF1B9DDE"),
                new ChartLegendItem("Inside Wallpaper", "#FFF59700"),
                new ChartLegendItem("Inside Avenue", "#FFF7EF1D"),
            };
        ...
        private IEnumerable<BarChartDataPoint> MakeRequestsBarChartDataSeries(IEnumerable<CombinedRequestsMetric> rawData)
        {
            ...
            foreach (var y in data)
                points.Add(new BarChartDataPoint((-1 * x++).ToString(), y.InsideFabric, y.InsideRugs, y.InsideWallpaper, y.InsideAvenue));
        ...
        private void FetchRequestsBarChartData()
        {
            ...
            try
            {
                ctx.CombinedTotalRequestsChartData(RequestsChartTimelineSeries, (result) =>
                {
                    if (result.HasError)
                    {
                    ...
                    {
                        var count = m.Value1 + m.Value2 + m.Value3 + m.Value4;
                        if (count > 10)
                        {
                            bForce10 = false;
                            break;
        ...
        void RequestsPerSecondMonitor_Tick(object sender, EventArgs e)
        {
            ...
            ctx.CombinedRequestsPerSecond((result) =>
            {
                if (result.HasError)
                {
                    result.MarkErrorAsHandled();
        ...
        private void SetDesignTimeData()
        {
            ...
            {
                new BarChartDataPoint("1", 5, 10, 25, 50),
                new BarChartDataPoint("2", 7, 10, 22, 19),
                new BarChartDataPoint("3", 19, 4, 2, 10),
                new BarChartDataPoint("4", 4, 5, 7, 4),
                new BarChartDataPoint("5", 10, 30,2,4),
                new BarChartDataPoint("6", 5, 3, 5, 10),
                new BarChartDataPoint("7", 0, 10, 10, 10),
                new BarChartDataPoint("8", 2, 5, 3, 12),
                new BarChartDataPoint("9", 7, 9, 10, 33),
                new BarChartDataPoint("10", 9, 30, 10, 30),
                new BarChartDataPoint("11", 5, 10, 25, 50),
                new BarChartDataPoint("12", 7, 10, 22, 19),
                new BarChartDataPoint("13", 19, 4, 2, 10),
                new BarChartDataPoint("14", 4, 5, 7, 4),
                new BarChartDataPoint("15", 10, 30,2,4),
                new BarChartDataPoint("16", 5, 3, 5, 10),
                new BarChartDataPoint("17", 0, 10, 10, 10),
                new BarChartDataPoint("18", 2, 5, 3, 12),
                new BarChartDataPoint("19", 7, 9, 10, 33),
                new BarChartDataPoint("20", 9, 30, 10, 30),
            };
